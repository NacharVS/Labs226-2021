...
namespace MyBank
{
    class Program
    {
        ...
        {
            BankAccount account1 = new BankAccount("Рафильджон Махмутович", 3000, 43);
            BankAccount account2 = new BankAccount("Василиса Макчикен", 100000, 20);
    ...
    class BankAccount
    {
        ...
        public static void Transaction(BankAccount accSeller, BankAccount accGetter)
        {
            if (accSeller.age > 18 & accGetter.age > 18)
            {
                ...
                {
                    Console.WriteLine("У тебя нет деняк, иди работай");
                }
                else
                {
