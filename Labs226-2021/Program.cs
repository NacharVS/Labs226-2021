...
namespace Labs226_2021
{
    class Program
    {
        ...
        {
            BankAccount account1 = new BankAccount("Ivan", 5000,18,1890);
            BankAccount account2 = new BankAccount("Kirill", 3000,10,1999);
            BankAccount account3 = new BankAccount("Elena", 6000,21,2000);
