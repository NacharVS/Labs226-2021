...
namespace Labs226_2021
{
    ...
    public class MarksObshaga
    {
        public static void MarksObs()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < students.Length; i++)
                {
                    if (students[i].sr >= ser)
                    {
                        ...
                        {
                            Console.WriteLine("Живёт в общежитии");
                        }
                    }
                }
                Console.WriteLine("Запустить заново? Если да - введите - y, если нет - n");
